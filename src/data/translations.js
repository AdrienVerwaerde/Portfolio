export const translations = {
  fr: {
    ...
    contact: {
      sectionTitle: "Restons Connectés",
      title: "Me Contacter",
    },
    about: {
      ...
      experienceDesc: "Développement Frontend et Backend<br><br>+ de 2 ans",
      education: "Formation",
      educationDesc:
        "Master (Titre Professionnel RNCP Niv7) - Manager de Projet Web et Digital (en cours) <br><br>Bachelor (Titre Professionnel RNCP Niv6) - Concepteur Développeur d'Applications (obtenu en 2025)<br><br>BTS (Titre Professionnel RNCP Niv5) - Développeur Web et Web Mobile (obtenu en 2024)",
      description:
    ...
    projects: {
      sectionTitle: "Découvrez Mes",
      title: "Projets Récents",
      hoverText: "(survolez l'image pour afficher sa variante)",
      moviepedia: {
        title: "Moviepedia",
        description:
          'Application responsive type "encyclopédie" créée avec JavaScript et React et utilisant l\'API du site IMDb pour afficher les films et leurs détails',
      },
      gamechamp: {
        title: "Gamechamp",
        description:
          "Une application créée avec Next.js qui intéragit avec une base de données MongoDB. Elle inclue plusieurs sections, un système d'authentification/création de compte et un tableau de bord administrateur pour gérer les articles et les utilisateurs",
      },
      cbdlisse: {
        title: "CBDlisse.fr",
        description:
  ...
  en: {
    ...
    about: {
      ...
      education: "Education",
      educationDesc:
        "Master's Degree - Web and Digital Projects Manager (in progress) <br><br>Bachelor's Degree - Apps Designer and Developer (graduated in 2025) <br><br>Diploma Advanced Technician - Web and Mobile Apps Developer (graduated in 2024)",
      description:
    ...
    projects: {
      ...
      title: "Projects",
      hoverText: "(hover the picture to see its variation)",
      moviepedia: {
        title: "Moviepedia",
        description:
          'Responsive "encyclopedia type" application created with JavaScript and React that uses IMDb\'s API to fetch movies and their data',
      },
      gamechamp: {
        title: "Gamechamp",
        description:
          "An application created with Next.js that fetches data from a MongoDB database. It includes different sections, an authentication/registration system and an admin dashboard to manage articles and users",
      },
      cbdlisse: {
        title: "CBDlisse.fr",
        description:
